...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($nome_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "INSERT INTO clientes (nome, password, email, data_nascimento, telemovel) VALUES (?, ?, 'teste', '2020-10-03', 919191911)";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "ss", $param_nome, $param_password);
